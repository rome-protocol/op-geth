...
func opCreate(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	res, addr, returnGas, suberr := interpreter.evm.Create(scope.Contract, input, gas, bigVal, 21000)
	log.Info("opCreate", "err", suberr)
