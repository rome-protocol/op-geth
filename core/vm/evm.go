...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address, typ OpCode) ([]byte, common.Address, uint64, error) {
	...
	// limit.
	log.Info("create address", "address", address, "caller", caller.Address().String())
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	log.Info("create contractAddr", contractAddr, "nonce", evm.StateDB.GetNonce(caller.Address()), "caller", caller.Address().String())
...
func (evm *EVM) Create2(caller ContractRef, code []byte, gas uint64, endowment *big.Int, salt *uint256.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	log.Info("create2", "hash", codeAndHash.Hash().String(), "contract address", contractAddr.String())
