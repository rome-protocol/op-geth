...
func (obj *Header) EncodeRLP(_w io.Writer) error {
	...
	_tmp6 := obj.SolanaBlockNumber != nil
	_tmp7 := obj.SolanaBlockHash != nil
	...
	if _tmp6 || _tmp7 {
		if obj.SolanaBlockNumber == nil {
			w.Write([]byte{0x80})
		} else {
			w.WriteUint64((*obj.SolanaBlockNumber))
		}
	}
	if _tmp7 {
		if obj.SolanaBlockHash == nil {
			w.Write([]byte{0x80})
		} else {
			w.WriteBytes(obj.SolanaBlockHash[:])
		}
	}
	w.ListEnd(_tmp0)
	return w.Flush()
